                ...
                <table class="table table-dark display" id="myTable">
                  <thead>
                    <tr>
                      <?php
                      $id = $_GET['id'];
                      $stmt = $conn->prepare("SELECT * FROM category_tbl WHERE cID = :id");
                  ...
                  <tbody style="color: black;">
                    <?php
                    $categ = $row['cCategory'];
                    $stmt = $conn->prepare("SELECT * FROM item_tbl WHERE cCategory = :categ");
                    ...
                    <tr>
                     ...
                     <?php
                      ...
                      <td><nobr><a href="view.php?id=<?=$row['cID']?>"><button class="btn" style="background-color: #337ab7; padding: 5px;"><i class="fas fa-eye" style="color: white;"></i></button></a>
                        <?php
                          if($row['cAvailability'] == 1){
                            ?>
                            <a href="../api/transac.php?id=<?=$row['cID']?>"><button class="btn" style="background-color: #d9534f; padding: 5px;"><i class="fas fa-folder-open" style="color: white;"></i></button></a>
                         <?php
                          }else{
                          ?>
                          <button disabled class="btn" style="background-color: #d9534f; padding: 5px;"><i class="fas fa-folder-open" style="color: white;"></i></button>
                          <?php
                        }
                          ?>
