            ...
            <div class="col-md-12">
                <div class="container mx-auto">
                    <div class="card">
                      ...
                      <div class="card-body">
                        <div class="col-md-6">
                            <form action="../api/addcert-process.php" method="post" enctype="multipart/form-data">
                              <div class="form-group">
                                <input type="text" class="form-control" placeholder="Certificate Name" name="txtcertname" required>
                              </div>
                              <div class="form-group">
                                  <select class="form-control" id="exampleFormControlSelect1" name="txtcategory">   
                                    <option value="" disabled selected hidden>Certificate Category</option>
                                    <option value="SAITE">SAITE</option>
                                    <option value="RAITE">RAITE</option>
                                    <option value="PSITE">PSITE</option>
                                  </select>
                              </div>
                              <div class="form-group">
                                <input type="file" class="form-control" placeholder="Description" name="txtfile">
                              </div>
                              <div class="form-group">
                                <input type="date" class="form-control" placeholder="Author" name="txtdate">
                              </div>                              
