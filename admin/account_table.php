    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
           <table class="table" id="myTable">
              <thead>
                <tr>
                  <th colspan="5" class="text-center">Account Table</th>
                </tr>
                <tr>
              ...
              <tbody>
                <?php
                $sql = $conn->prepare("SELECT * FROM user_tbl");
                $sql->execute();
                ...
                <tr>
                  ...
                  <td><?=$row['cCourse']?></td>
                  <td>
                    <a href="edit_account.php?id=<?=$row['cID']?>" class="btn btn-success btn-xs"><i class="fas fa-edit"></i></a>
                    <a href="../api/delete-process.php?id=<?=$row['cID']?>" class="btn btn-danger btn-xs"><i class="fas fa-trash"></i></a>
                  </td>
                </tr>
