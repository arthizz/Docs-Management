            ...
            <div class="col-md-12">
                <div class="container mx-auto">
                    <div class="card">
                      ...
                      <div class="card-body">
                        <div class="col-md-6">
                            <form action="../api/addprojects-process.php" method="post" enctype='multipart/form-data'>
                              <div class="form-group">
                                <input type="text" class="form-control" placeholder="Project Name" name="txtprojectname" required>
                              </div>
                              <div class="form-group">
                                  <select class="form-control" id="selectbox" onchange="changefunc();" name="txtcategory">
                                    <?php
                                        $stmt = $conn->prepare("SELECT * FROM category_tbl LIMIT 3");
                                        $stmt->execute();
                              ...
                              <div class="form-group">
                                <input type="text" class="form-control" placeholder="Description" name="txtdescription">
                              </div>
                              <div class="form-group">
                                <input type="text" class="form-control" placeholder="Author" name="txtauthor">
                              </div>
                              <div class="form-group">
...
<!--     <script>
        function changefunc(){
            ...
            if (selectedValue == "MRW"){
                document.getElementById("flie").type = "file";
                document.getElementById("flie2").type = "file";
