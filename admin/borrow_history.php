...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            <div class="col-md-12">
               <h3 class="lead text-center py-3">Borrow Results</h3>
               
                <table class="table" id="myTable">
                  <thead>
                    <tr>
                        <h5 class="lead text-center"> Transaction </h5>
                    </tr>
                    <tr>
                  ...
                  <tbody> 
                    ...
                    <?php
                        $stmt = $conn->prepare("SELECT * FROM transac_tbl");
                        $stmt->execute();
                    ...
                    <tr>
                        ...
                        <td><?=$row['cStudent_name']?></td>
                        <td><?=$row['cItem_name']?></td>
                        <td><?=$row['cDat']?></td>

                        <?php
                        if($row['cAvailability'] == 0){

                        ?>
                        <td><a href="../api/update_transac.php?id=<?=$row['cID']?>&&name=<?=$row['cItem_name']?>"><button class="btn btn-xs btn-success">BORROWED</button></a></td>
                        <?php
                    }else{
