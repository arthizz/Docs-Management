        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse pt-5">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="graph.php" class="dropdown-toggle"> <i class="fas fa-table"></i> Add Project Part </a>
                    </li>
                    <li class="menu-item-has-children dropdown">
            ...
            <div class="col-md-12">
                <div class="container mx-auto">
                    <div class="card">
                      ...
                      <div class="card-body">
                        <div class="col-md-6">
                            <form action="../api/addprojects-process.php" method="post">
                              <div class="form-group">
                                <input type="text" class="form-control" placeholder="Chapter" name="txtchapter" required>
                              </div>
                              <div class="form-group">
                                  <label for="exampleInputEmail1">Upload PDF</label>
                                  <input type="file" class="form-control" placeholder="Description" name="txtdescription">
                              </div>
                              <div class="form-group">
